...
$document
		.ready(function() {
			...
			// queryform
			if (plugins.queryForm3.length) {
				var $queryform3 = plugins.queryForm3;
				console.log("12134");
				$queryform3
					.validate({
						submitHandler : function(form) {
			...
			// gouback
			if (plugins.queryForm1.length) {
				var $queryforme1 = plugins.queryForm1;
				...
				$queryforme1
					.validate({
						submitHandler : function(form) {
							...
							var destinationLocation = $("#target").val();
							var startTime = $("#date").val();
							console.log(orginLocation);
							var json = {
								"orginLocation" : orginLocation,
								"destinationLocation" : destinationLocation,
								"startTime" : startTime
							}
							 orginLocation = $("#target").val();
							 destinationLocation = $("#source").val();
							 startTime = $("#date").val();
							var json1 = {
								"orginLocation" : orginLocation,
								"destinationLocation" : destinationLocation,
